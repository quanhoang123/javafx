...
public class Phieu_DangNhapKH  extends Stage{

	public static boolean stateLogin = false;
	IKhachHangManager khachhang = new IKhachHangManagerImpl();
	
	public Phieu_DangNhapKH() {
		...
		pw.setOnKeyPressed(new EventHandler<KeyEvent> () {
			...
			public void handle(KeyEvent event) {
				if (event.getCode() == KeyCode.ENTER) {
					if (khachhang.checkLogin(txUsername.getText(), pw.getText())) {
					close();
						stateLogin = true;
					} else {
